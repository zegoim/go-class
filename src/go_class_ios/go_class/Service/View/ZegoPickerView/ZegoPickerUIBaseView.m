...
#import "ZegoPickerUIBaseView.h"


@interface ZegoPickerUIBaseView ()


@end
@implementation ZegoPickerUIBaseView
...
- (ZegoPickerViewManager *)manager
{
    if (!_manager ) {
        _manager = [ZegoPickerViewManager new];
    }
    return _manager;
}
#pragma mark - 背景遮罩图层
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont boldSystemFontOfSize:self.manager.titleSize];
