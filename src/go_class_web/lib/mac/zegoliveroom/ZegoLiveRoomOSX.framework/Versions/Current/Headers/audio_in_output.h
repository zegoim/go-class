...
namespace AVE
{
    ...
    public:
		...
		virtual void onRecordAudioFrameDirectly(const AudioFrame& audioFrame) = 0; //Internal use of engine only
		virtual void onRecordAudioFrameInnerAsyn(const AudioFrame& audioFrame) = 0;//Internal use of engine only
	};
