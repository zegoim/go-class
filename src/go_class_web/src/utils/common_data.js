...
const APP_VERSION_STRING = '2.8.0' // APP 字符串版本号（主版本号 + 次版本号 + 补丁号）
const APP_VERSION_ARRAY = APP_VERSION_STRING.split('.')
const APP_VERSION = countNumVersion(
  APP_VERSION_ARRAY[0],
  APP_VERSION_ARRAY[1],
  APP_VERSION_ARRAY[2],
  0
) // APP 数字版本号
const WHITEBOARDVIEW_VERSION = '1.21.0' // 白板 SDK 版本
const DOCSVIEW_VERSION = '1.21.0' // 文件 SDK 版本
